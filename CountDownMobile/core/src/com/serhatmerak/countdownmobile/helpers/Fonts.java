...
public class Fonts {
    ...
    public static BitmapFont bl_bold_156;
    public static BitmapFont consola18;

    public static String characters =  ":“”…>×abâîcçdefgğhıijklm’noö'><öprsştuüvwyxzqABCÇDEFGĞHIİJKLMNOÖPRSŞTUÜVXWYZQ:,?.=!0123456789:+\"() / -%";
    ...
    public static void createFonts(){
        ...
        bl_bold_156.getData().markupEnabled = true;
    ...
    private static void createBlinkerBold() {
        ...
        bl_bold_156 = generator.generateFont(parameter80); // font size 12 pixels
